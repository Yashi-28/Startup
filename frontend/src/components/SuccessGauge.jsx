...
const SuccessGauge = ({ score }) => {
  ...
  return (
    <div className="flex flex-col items-center justify-center p-4 bg-dark-card/50 rounded-2xl border border-dark-border/50">
      ...
      <div className="mt-3 text-center">
        <span className="text-xs text-gray-400 font-medium">Success Outlook</span>
